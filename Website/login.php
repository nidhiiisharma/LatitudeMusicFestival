				...
				<div class="row">
					<div class="col">
						<div class="home_content">
							<div class="home_title" style="color:white; margin-top:-70px;">Login</div>
							<form action="includes/login.inc.php" method="POST" style="margin-top:80px;">
								<div class="row">
									<label class="email_login">E-mail Address:</label>
									<input type="email" name="email" required="required" style="margin-left: 460px; margin-top:-30px; width: 40%; margin-bottom: 15px; font-size: 15px;">
								</div>
								<div class="row">
									<label class="password_login">Password:</label>
									<input type="password" name="password" required="required" style="margin-left: 460px; margin-top:-30px; width: 40%; margin-bottom: 15px; font-size: 15px;">
								</div>
								<div class="row">
									<p id="no_account"><a href="signup.php">Don't have an account?</a></p>
								</div>
								  <button type="submit" name="submit" style="margin-left:55%;margin-top: 20px;padding: 5px 5px;width: 30%;box-sizing: border-box;border:1px solid black;font-size:15px;font-weight: 600;background-color: white;letter-spacing: 2px;margin-bottom: 30px;">Login</button>
							</form>
					</div>
				</div>
			</div>
